...
{if $print_page ne "y"}
	...
	<div id="wrap1" class="pkg-{$gBitLoc.ACTIVE_PACKAGE|lower}" style="background-image:none; filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://localhost/tp/clyde/themes/styles/jill/images/logo.png',sizingMethod='scale')">
	<div id="wrap2">
