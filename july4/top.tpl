...
<tr>
	...
	<td bgcolor="#b40019" align="left" style="vertical-align: bottom;color: #ffffff;padding:3px;"><h1 style="vertical-align: bottom;color: #ffffff;">{$gBitSystem->getConfig('site_title')|default:"bitweaver"}</h1>
			<h2 style="vertical-align: bottom;color: #ffffff;font-size:small;">{$gBitSystem->getConfig('site_slogan')}</h2>
